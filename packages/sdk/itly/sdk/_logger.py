...
class LoggerPrefixSafeDecorator(Logger):
    ...
    def debug(self, message):
        ...
        try:
            ...
            self._fallback_logger.error(self._prefix + 'Error in logger.debug(). {0}.'.format(str(e)))
    ...
    def info(self, message):
        ...
        try:
            ...
            self._fallback_logger.error(self._prefix + 'Error in logger.info(). {0}.'.format(str(e)))
    ...
    def warn(self, message):
        ...
        try:
            ...
            self._fallback_logger.error(self._prefix + 'Error in logger.warn(). {0}.'.format(str(e)))
    ...
    def error(self, message):
        ...
        try:
            ...
            self._fallback_logger.error(self._prefix + 'Error in logger.error(). {0}.'.format(str(e)))
